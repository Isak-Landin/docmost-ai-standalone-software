...
DOCMOST_FETCHER_INTERNAL_BASE_URL = os.getenv("DOCMOST_FETCHER_INTERNAL_BASE_URL", "http://docmost:8099")
docmost_fetcher_spaces_endpoint = DOCMOST_FETCHER_INTERNAL_BASE_URL + os.getenv("SPACES_PATH", "/api/spaces")
